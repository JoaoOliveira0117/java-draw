...
public class GaussianFilterModal extends ConfirmationModal {
  public GaussianFilterModal(ProcessableImage image) {
  ...
  private static ConfirmationModalListener createListener(ProcessableImage image) {
    ...
    return new ConfirmationModalListener() {
      ...
      public void onConfirm() {
        image.setImage(commitableImage.gaussianFilter().getImage());
